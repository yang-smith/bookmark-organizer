  ...
  FAQ_EN: [
    {
      ...
      answer:
        "I've always struggled with the clutter in my Chrome bookmarks. Manually organizing them into folders was time-consuming and tedious. So, I spent a weekend creating this plugin that uses AI to automatically categorize bookmarks into appropriate folders.",
    },
    {
      question: "The project seems a bit rough around the edges. Why is that?",
      answer:
        "You're right - it's a weekend project that covers the basics. I focused on core functionality. If you have ideas for improvements, please reach out to me at zy892065502@gmail.com. The project is also open-source on GitHub, so feel free to modify it to suit your needs.",
    },
    {
      question: "What should I do if I encounter issues while using the extension?",
      answer:
        "If you run into any problems while using the extension, please don't hesitate to contact me via Twitter or email. I'm here to help!",
    },
  ],
  ...
  FAQ_ZH: [
    {
      question: "为什么会有这个项目？",
      answer:
        "我自己一直头疼于chrome收藏夹的杂乱，使用文件夹管理的话自己一个个分类又很麻烦。因此花了一个周末写了这个小插件，使用AI帮我讲书签分门别类放到文件夹里面",
    },
    {
      question: "这个项目看起来很粗糙？",
      answer:
        "那对了，这是一个周末开发的项目，实现了基本功能，如果你有其他想法，欢迎联系我zy892065502@gmail.com。 同时这个项目也开源在GitHub上，你可以根据自己的需要进行修改。",
    },
    {
      question: "如果我在使用中遇到问题该怎么办？",
      answer:
        "如果你在使用中遇到任何问题，请通过Twitter或者邮箱与我联系。",
    },
  ],
